import { IType, IAnyType, ExtractNodeType } from "../../internal";
/** @hidden */
 ...
 * Snapshot processors.
 */
export interface ISnapshotProcessors<C, CustomC, S, CustomS, IT extends IAnyType> {
    /**
     ...
     * @param snapshot
     */
    postProcessor?(snapshot: S, node: ExtractNodeType<IT>): CustomS;
}
/**
 ...
 * @returns
 */
export declare function snapshotProcessor<IT extends IAnyType, CustomC = _NotCustomized, CustomS = _NotCustomized>(type: IT, processors: ISnapshotProcessors<IT["CreationType"], CustomC, IT["SnapshotType"], CustomS, IT>, name?: string): ISnapshotProcessor<IT, CustomC, CustomS>;
export {};
